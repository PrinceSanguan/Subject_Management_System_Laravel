            ...
            <form class="d-flex">
                <ul class="navbar-nav mr-auto" id="center">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="{{route('admin.dropping')}}" id="dropping">Dropping</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="bg-container">
        ...
        <div class="content">
            ...
            <div class="add-request-label" style="display: flex; justify-content: space-between; padding-bottom: 20px;">
                <p style="font-weight:bold">DROP SUBJECT REQUESTS:</p>
                    ...
                    <tbody id="table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-primary" href="">Enlist</a>
                                <br>
                                <a class="btn btn-primary disabled" aria-disabled="true">Enlist</a>
                                <br> 
                        </tr>
