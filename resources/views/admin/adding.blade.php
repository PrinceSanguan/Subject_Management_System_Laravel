...
<body>
    ...
    <nav class="navbar navbar-expand-lg" id="navbarnavbar">
        <div class="navbarLagayan">
            <img src="{{asset('images/tuplogo.png')}}" width="30" height="30">
          ...
          <form class="d-flex">
            <ul class="navbar-nav mr-auto" id="center">
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="{{route('admin.adding')}}" id="adding">Adding</a>
              </li>
                <li class="nav-item">
    ...
    <div class="bg-container">
        ...
        <div class="content">
            ...
            <div class="add-request-label" style="display: flex; justify-content: space-between; padding-bottom: 20px;">
                <p style="font-weight:bold">ADD SUBJECT REQUESTS:</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 stretch-card grid-margin">
                        <div class="card bg-gradient-success card-img-holder text-white">
                            <div class="card-body">
                                <img src="{{asset('images/circle.png')}}" class="card-img-absolute" alt="circle-image" />
                                <h4 class="font-weight-normal mb-3">Enrolled <i class="mdi mdi-diamond mdi-24px float-right"></i>
                                </h4>
                                <h2 class="mb-5"></h2>
                            </div>
                        </div>
            ...
            <div style="overflow-x:auto;" id="tab">
                ...
                <table class="table table-bordered" id="demo" style="width: 100%;">
                    <thead>
                        <tr>
