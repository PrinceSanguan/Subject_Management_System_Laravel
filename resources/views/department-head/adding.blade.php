...
<head>
    ...
    <title>TUPC Department Head: Add Subject</title>
    ...
    <!--CSS Custom -->
    <link rel="stylesheet" href="{{asset('css/h_adding.css')}}">
          ...
          <form class="d-flex">
            <ul class="navbar-nav mr-auto" id="center">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="{{route('department-head.adding')}}" id="adding" style="display: flex;">Adding<span></i></span></a>
                </li>
                <li class="nav-item">
