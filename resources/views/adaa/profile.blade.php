...
<head>
    ...
    <title>TUPC ADAA: All Subjects</title>
    ...
    <!--CSS Custom -->
    <link rel="stylesheet" href="{{asset('css/r_profile.css')}}">
            ...
            <form class="d-flex">
                <ul class="navbar-nav mr-auto" id="center">
                    <li class="nav-item active">
                        <a class="nav-link" href="{{route('adaa.profile')}}" id="profile">Profile</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('adaa.adding')}}" id="" style="display: flex;">Adding<span></span></a>
                    </li>
                    <li class="nav-item">
